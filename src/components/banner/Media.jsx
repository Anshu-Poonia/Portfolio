      ...
      <div>
        ...
        <div className="flex gap-4">
          <span className="bannerIcon">
            <span className="bannerIcon">
              <a href="https://www.linkedin.com/in/anshu-poonia" target="_blank" rel="noopener noreferrer">
                <FaLinkedinIn />
              </a>
            </span>
          </span>
          <span className="bannerIcon">
            <a href="https://github.com/Anshu-Poonia" target="_blank" rel="noopener noreferrer">
              <FaGithub />
            </a>
          </span>
        </div>
